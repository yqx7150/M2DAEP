function net2 = multich_loadNet_qx3channel_diffSigma2_RED(img_size, use_gpu)
...
net_model = './Multich_model/deploy_RED_net_2.prototxt';
...
fclose(FID_base);
FID_net = fopen('./Multich_model/deploy_RED_resized_2.prototxt', 'w');
fprintf(FID_net, char(Str_base), net_size);
fclose(FID_net);
net_model = './Multich_model/deploy_RED_resized_2.prototxt';
